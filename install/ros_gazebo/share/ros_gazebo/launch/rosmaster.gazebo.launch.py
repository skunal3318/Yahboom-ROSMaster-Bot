...
def generate_launch_description():
    ...
    package_name_gazebo = 'ros_gazebo'
    package_name_description = 'rosmaster_description'
    package_name_bringup = 'ros_bringup'
    ...
    rviz_config_filename = 'rosmaster_gazebo_sim.rviz'
