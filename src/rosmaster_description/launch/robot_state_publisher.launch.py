...
def process_ros2_controllers_config(context):
    ...
    src_config_path = os.path.join(
        home,
        'ros2_ws/src/rosmaster_description/config',
        robot_name
    )
    install_config_path = os.path.join(
        home,
        'ros2_ws/install/rosmaster_description/share/rosmaster_description/config',
        robot_name
    )
...
def generate_launch_description():
    # Define filenames
    urdf_package = 'rosmaster_description'
    urdf_filename = 'rosmaster_x3.urdf.xacro'
    rviz_config_filename = 'rosmaster_description.rviz'
